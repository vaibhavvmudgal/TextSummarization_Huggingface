...
llm=HuggingFaceEndpoint(repo_id=repo_id,max_length=150,temperature=0.7,huggingfacehub_api_token='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')
...
if st.button("Summarize the Content"):
    ...
    if not hf_api_key.strip() or not generic_url.strip():
        st.error("Please enter the Huggingface API token to get started")
